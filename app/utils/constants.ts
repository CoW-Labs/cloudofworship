...
export const quickActionsArr: QuickAction[] = [
  ...
  },
  {
    ...
    name: "Intermission Settings",
    desc: "Set the background shown on live output when no slide is live",
    action: appWideActions.openSettings,
    actionArg: "Intermission Settings",
    meta: "intermission idle screen branding background video image logo",
    searchableOnly: true,
    tier: "free",
  },
  {
